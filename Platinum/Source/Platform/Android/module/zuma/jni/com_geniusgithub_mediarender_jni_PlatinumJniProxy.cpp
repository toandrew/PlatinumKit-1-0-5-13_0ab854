...
static const char *classPathName = "com/geniusgithub/mediarender/jni/PlatinumReflection";
  ...
  (JNIEnv *env, jclass, jbyteArray name, jbyteArray uuid) 
{
    ...
    int ret = g_DMRCenter->Start(c_name, c_uuid);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_geniusgithub_mediarender_jni_PlatinumJniProxy_stopMediaRender
  (JNIEnv *env, jclass)
{
 ...
 * Signature: (Z)Z
 */
JNIEXPORT jboolean JNICALL Java_com_geniusgithub_mediarender_jni_PlatinumJniProxy_enableLogPrint
